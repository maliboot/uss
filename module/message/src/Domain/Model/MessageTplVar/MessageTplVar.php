 ...
 */
namespace Uss\Message\Domain\Model\MessageTplVar;
 ...
 */
#[AggregateRoot(name: 'MessageTplVar', desc: '消息模板-变量')]
class MessageTplVar extends AbstractEntity implements AggregateRootInterface
{
    #[Field(name: '')]
    private int $id;
    ...
    #[Field(name: '变量类型，0字符串 1list 2map')]
    private int $type;

    #[Field(name: '变量名，模板变量替换时使用')]
    private string $name;
    ...
    #[Field(name: '使用例子，尤其当type=list、map时，应该给出示例说明规范')]

...
return [
    'paths' => [
        ...
        'generator' => [
            ...
            FileType::APP_EXECUTOR_MOBILE => ['path' => 'src/App/Executor/Mobile', 'generate' => false, 'gitignore' => true],
            FileType::APP_EXECUTOR_WAP => ['path' => 'src/App/Executor/Wap', 'generate' => false, 'gitignore' => true],
            FileType::APP_EXECUTOR_WEB => ['path' => 'src/App/Executor/Web', 'generate' => false, 'gitignore' => true],
            ...
            FileType::APP_EXECUTOR_COMMAND_MOBILE => ['path' => 'src/App/Executor/Command/Mobile', 'generate' => true, 'gitignore' => true],
            FileType::APP_EXECUTOR_COMMAND_WAP => ['path' => 'src/App/Executor/Command/Wap', 'generate' => true, 'gitignore' => true],
            FileType::APP_EXECUTOR_COMMAND_WEB => ['path' => 'src/App/Executor/Command/Web', 'generate' => true, 'gitignore' => true],
            ...
            FileType::APP_EXECUTOR_QUERY_MOBILE => ['path' => 'src/App/Executor/Query/Mobile', 'generate' => true, 'gitignore' => true],
            FileType::APP_EXECUTOR_QUERY_WAP => ['path' => 'src/App/Executor/Query/Wap', 'generate' => true, 'gitignore' => true],
            FileType::APP_EXECUTOR_QUERY_WEB => ['path' => 'src/App/Executor/Query/Web', 'generate' => true, 'gitignore' => true],
            ...
            FileType::CLIENT_VIEW_OBJECT => ['path' => 'src/Client/Vo', 'generate' => true, 'gitignore' => true],
